...
//     unread: 3,
//     type: "group",
//     members: ["alice#dev", "bob#designer", "charlie#pm"],
//   },
//   {
//     id: 2,
//     name: "Design Team",
...
//     unread: 5,
//     type: "group",
//     members: ["alice#dev", "charlie#pm", "eve#admin"],
//   },
//   {
//     id: 4,
//     name: "Marketing",
...
//     roomId: 1,
//     sender: "You",
//     content: "That would be great, Alice!",
//     timestamp: "10:41 AM",
//     isUser: true,
//   },
...
//     activeRoomId ? selectMessagesByRoom(state, activeRoomId) : []
//   );
...
//         user.tag.includes(searchTerm.toLowerCase())) &&
...
//                             onClick={() =>
//                               handleSelectUser(`${user.name}#${user.tag}`)
//                             }
//                           >
