...
export default function InvitesPage() {
  ...
  const handleRejectInvite = (inviteId: number) => {
    ...
    dispatch(rejectInvite(inviteId))
  }
            ...
            {pendingInvites.map((invite) => (
              <Card key={invite.id}>
                <CardHeader>
                  ...
                  <CardDescription>{invite.room.type === "direct" ? "Direct Message" : "Group Chat"}</CardDescription>
                </CardHeader>
                <CardContent>
                  <p>
                    You've been invited to join this {invite.room.type === "direct" ? "conversation" : "group"} by{" "}
